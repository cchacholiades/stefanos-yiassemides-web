<template>
    <div v-if="works">
        <div class="font-sourceCodePro text-center text-3xl sm:text-4xl font-bold pt-20 sm:pt-32 pb-10">CREDITS</div>
        <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4 mt-4">
            <div v-for="work in works" :key="work.id" class="relative flex flex-col rounded items-baseline cursor-pointer aspect-w-4 aspect-h-5" @click.prevent="showOverlay(work)">
                ...
                <div class="bg-black bg-opacity-80 opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 px-4 flex justify-center items-center text-center text-lg text-white font-semibold font-sourceCodePro">
                    {{ work.name }}
                </div>
            </div>
        </div>
        <div v-if="shouldDisplayOverlay" class="font-sourceCodePro fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black bg-opacity-90 z-50">
            <div class="flex flex-col px-4 max-w-md md:max-w-lg">
                ...
                <div>
                    ...
                    <p class="mt-4 break-words">{{ selected.description }}</p>
                    <!-- <p v-if="selected.youtube">{{ selected.youtube }}</p> -->
                    <!-- <p v-if="selected.vimeo">{{ selected.vimeo }}</p> -->
                </div>
            </div>
        </div>
    </div>
        ...
        return {
            works: [
                ...
                },
                {
                    ...
                    description: `Animated series for kids based on the Mega Bloks&reg; line of construction set toys. Produced by <a class="inline-link link" href="https://www.moonbug.com/" rel="noopener" target="_blank" rel="nofollow">Moonbug Entertainment</a>.`,
                    youtube: "https://www.youtube.com/playlist?list=PLKCNCfD_4af8sxGFvIuYG3k9nvJQkv58r",
                },
                {
                    id: 9,
                    img: "works/9.jpg",
                    ...
                    youtube: "https://youtu.be/T__-goYTu3Q",
                },
                {
                    id: 10,
                    img: "works/10.jpg",
                ...
                },
                {
                    ...
                    img: "works/12.png",
                    name: "Rescue Heroes",
                    description: `Stop-motion animated series for kids produced by <a class="inline-link link" href="https://www.moonbug.com/" target="_blank" rel="noopener">Moonbug Entertainment</a>. Based on the Fisher-Price&reg; toy line of "Rescue Heroes", this online series tracks the adventures of a team of emergency responders who rescue people from various disasters.`,
                    youtube: "https://www.youtube.com/playlist?list=PLKCNCfD_4af-UtKntqcAQsPZykytye5lU",
                },
                {
                    id: 13,
                    img: "works/13.jpg",
                    ...
                    youtube: null,
                    vimeo: "https://player.vimeo.com/video/229325041",
                },
                {
                    id: 14,
                    img: "works/14.jpeg",
                    ...
                    youtube: null,
                    vimeo: "https://player.vimeo.com/video/239726433",
                },
                {
                    id: 15,
                    img: "works/15.jpg",
                    ...
                    youtube: null,
                    vimeo: [
                        "https://player.vimeo.com/video/239732509",
                        "https://player.vimeo.com/video/239732509"
                    ]
                },
            ],
