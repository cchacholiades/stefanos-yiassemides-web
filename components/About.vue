<template>
    <div class="mt-4">
        ...
        <div class="sm:flex text-lg md:text-xl">
            <img  class="w-full mb-6 sm:mb-0 sm:w-56 sm:h-56 mr-4 rounded-2xl object-cover grayscale" src="/stefanos-yiassemides-web/about-2.jpeg" alt="Stefanos Yiassemides portrait image">
            <div>
